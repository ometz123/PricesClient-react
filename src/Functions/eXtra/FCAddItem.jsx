...
export default function FCAddItem(props) {
    ...
    const handleItemImage = (imageSrc, base64) => {
        ...
        setTempItem({
            ...tempItem, image: {
                preview: base64 === "src" ? imageSrc : URL.createObjectURL(imageSrc),
                raw: imageSrc,
                base64: base64
            }
        })
    ...
    const useItemFromApi = (item, src) => {
        ...
        setTempItem({
            ...tempItem,
            itemName: item.title,
            image: { preview: src, raw: src, base64: "src" },
                ...
                <div>
                    <DialogContent>
                        ...
                        <div style={{ float: "left" }} >
                            ...
                            />
                            <IconButton
                                onClick={() => { handleBarcode(tempBarcode) }}
                                aria-label="Search Item from API"
                                color={"primary"}
                            >
                                <SearchTwoToneIcon />
                            </IconButton>
